...
| `/ingest [source]` | wiki-core | Fold a source into the wiki — accepts a `raw/` source, a path/URL, or an attachment/pasted text block (auto-landed); no argument ingests the next worklist item |
