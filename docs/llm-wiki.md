...
- **Obsidian Web Clipper** for getting sources into `raw/`
- **Attachment folder path:** `raw/assets/`
- **Obsidian graph view** for wiki shape
- **Marp** and **Dataview** optional
- The wiki is just a git repo of markdown files

## Note

This document is intentionally abstract. The exact directory structure and conventions depend on your domain. Co-evolve `AGENTS.md` with your agent as you go.